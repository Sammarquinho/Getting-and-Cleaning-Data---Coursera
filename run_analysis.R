...
library(data.table)
setwd("C:/Users/ Client / OneDrive /  Documentos / Coursera / Curso de Obtenção e Limpeza de Dados")
url <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
download.file( url, destfile = "data.zip" )
unzip("data.zip")

# list.files(), reset the working directory
setwd("C:/Users / Clien / OneDrive / Documentos / Coursera / Curso de Obtenção e Limpeza de Dados / UCI HAR  Dataset")
...
# set the column names for data2, does the task required in Step 4 : Appropriately labels the data set with descriptive variable names.
...
setwd("C: / Usuários / Cliente / OneDrive / Documents / Coursera / Curso de Obtenção e Limpeza de Dados")
